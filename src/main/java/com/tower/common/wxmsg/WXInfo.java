...
public class WXInfo {
	...
	//4	mhhQcSxoAucApWFIIBjlMB3M1L2HvD1kE8cR8oH_skA	任务处理通知	
	public static final String topcolor="#FF0000";

	public static final String taskTemplateid="mhhQcSxoAucApWFIIBjlMB3M1L2HvD1kE8cR8oH_skA";
	public static final String taskUrl="%s/manager/get_service.html?adminselectstate=1&msgorderid=%d&openid=%s";
	
	public static final String moneyTemplateid="bm00Qlw4H4eOrcbFrBOhdxuOLRo38OasxgnLoni1oiM";
	...
	public static final String dk_successTemplateid="RdA5AEwt-B9wdnAxepM8gByvy0FkSV3_uxt2CFjGZvI";
	public static final String dk_successUrl="%s/money/tx_record_list.html?openid=%s&txid=%s";
	
	public static final String send_tw_noticeTemplateid="mhhQcSxoAucApWFIIBjlMB3M1L2HvD1kE8cR8oH_skA";
	public static final String send_tw_noticeUrl="%s/twnotice/noticeinfo.html?noticeid=%d";
	
	public static final String dk_apply_successTemplateid="RdA5AEwt-B9wdnAxepM8gByvy0FkSV3_uxt2CFjGZvI";
	public static final String dk_apply_successUrl="%s/money/mymoney.html?openid=%s";
	
	public static final String sh_order_yqTemplateid="VZ7pVXEReFFQUY_rfQwdxPs-NSqk48EUJAtuNOhsT_s";
	public static final String sh_order_yqUrl="%s/order/order_list.html?msgorderid=%d&openid=%s";
	
	//验证通过
	public static final String user_verity_successTemplateid="VZ7pVXEReFFQUY_rfQwdxPs-NSqk48EUJAtuNOhsT_s";
	...
	public static final String  money_add_type_first="付款到账";
	...
	//++++++++++++++++目标建站审核通知内容++++++++++++++++++++++++++
		...
		public static final String order_post_undo_user="内蒙古铁塔";
		...
		public static final String user_verity_user="内蒙古铁塔";

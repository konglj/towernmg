...
private String towerfactaddress;
	...
	public String getTowerbh() {
		return towerbh;
	}

	public void setTowerbh(String towerbh) {
		this.towerbh = towerbh;
	}

	public String getTowerenddate() {
		return towerenddate;
	}

	public void setTowerenddate(String towerenddate) {
		this.towerenddate = towerenddate;
	}
	...
	public int getTowerrentyear() {
		return towerrentyear;
	}

	public void setTowerrentyear(int towerrentyear) {
		this.towerrentyear = towerrentyear;
	}

...
public class ReportServiceImpl implements ReportService {
	...
	@Override
	public List<ReportTower> getReportTowers(ReportTowerPage reportTowerPage) {
		int count = reportMapper.getReportTowersCount(reportTowerPage);
		reportTowerPage.setPagerowtotal(count);
		return reportMapper.getReportTowers(reportTowerPage);
	}
	@Override
	public List<Map> getDCReportTowers(ReportTowerPage reportTowerPage) {
		return reportMapper.getDCReportTowers(reportTowerPage);
	}
